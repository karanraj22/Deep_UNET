...
# Source image path.
source_image_path = "./catalogues/Mars_HRSC_MOLA_BlendDEM_Global_200mp_v2_2400.png"

# LROC crater catalog csv path.
#lroc_csv_path = "./catalogues/LROCCraters.csv"

# Head et al. catalog csv path.
head_csv_path = "./catalogues/mars_crat.csv"
...
# Radius of the world in km (1737.4 for Moon). 6052 for venus and 3390 for mars 
R_km = 3390
...
ringwidth = 3 #change from 1 to 3 @by karanraj
