...
def ReadLROCHeadCombinedCraterCSV(filehead="catalogues/HeadCraters.csv",
                                  sortlat=True):
...
def PlateCarree_to_Orthographic(img, llbd, craters, iglobe=None,
                                ctr_sub=False, arad=3390, origin="upper",
...
def GenDataset(img, craters, outhead, rawlen_range=[1000, 2000],
               ...
               arad=3390, minpix=0, tglen=256, binary=True, rings=True,
